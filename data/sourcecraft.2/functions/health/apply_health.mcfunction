...
execute if score #health_difference sourcecraft.temp < #max_health sourcecraft.temp if score #apply_health sourcecraft.temp matches 1.. run function sourcecraft.2:health/current/give_attributes

#else if calculated difference is more than 1 (ignoring 0): damage player
execute if score #health_difference sourcecraft.temp < #max_health sourcecraft.temp if score #apply_health sourcecraft.temp matches ..-1 run function sourcecraft.2:health/current/damage
