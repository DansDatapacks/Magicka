...
execute as @a unless score @s sourcecraft.temp = @s sourcecraft.slot run function sourcecraft.2:check_hand/on_hotbar_scroll
...
schedule function sourcecraft.2:loop/detect_hotbar_scroll 1t replace