...
#module loops
execute if score #sourcecraft.module.player_ID sourcecraft.data matches 1 run schedule function sourcecraft.2:loop/give_player_id 1t replace
scoreboard players reset #sourcecraft.module.player_ID sourcecraft.data
execute if score #sourcecraft.module.check_hand sourcecraft.data matches 1 run schedule function sourcecraft.2:loop/detect_hotbar_scroll 1t replace
scoreboard players reset #sourcecraft.module.check_hand sourcecraft.data
execute if score #sourcecraft.module.click_detect sourcecraft.data matches 1 run schedule function sourcecraft.2:loop/detect_click 1t replace
scoreboard players reset #sourcecraft.module.click_detect sourcecraft.data
execute if score #sourcecraft.module.player_death_detect sourcecraft.data matches 1 run schedule function sourcecraft.2:loop/detect_player_death 1t replace
